	...
	if (isset($my_custom_field )):
		...
		<?php if ( $the_query->have_posts() ) : ?>
		    ...
		    <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
				...
				<div class="post-item col-xs-12 col-sm-6 col-md-4 item-<?php echo ($count);?>">
					<?php
					...
					<p><?php the_title(); ?> <br> <?php echo ($postExcerpt);?> <br> <a href="<?php echo (get_permalink( $post->ID ));?>">Read More</a></p>
				</div>
				<?/*?>
			...
			<?php endwhile; ?>
			<div class="col-xs-12">
				<p class="text-center" style="margin-top:50px;"><a class="button" href="<?php echo (home_url('/blog/'));?>" href="">More Articles</a></p>
			</div>
		    <!-- end of the loop -->
