...
(function($) {
    ...
    wpLink = {
        ...
        init: function() {
            var fsRelHtml = '<div style="margin-left: 3px;"><label><span> </span><input type="checkbox" id="rel-nofollow-checkbox" /> rel="nofollow"</label></div>';
            $(fsRelHtml)
            ...
            inputs.close.add(inputs.backdrop)
                .add('#wp-link-cancel a')
            ...
            $('#wp-link-search-toggle')
                .on('click', wpLink.toggleInternalLinking);
            ...
            inputs.search.on('focus.wplink', function() {
                    ...
                    inputs.queryNoticeTextHint.removeClass('screen-reader-text')
                        .show();
                })
                .on('blur.wplink', function() {
                    inputs.queryNoticeTextDefault.show();
                    inputs.queryNoticeTextHint.addClass('screen-reader-text')
                        .hide();
                });
        ...
        open: function(editorId) {
            ...
            this.textarea = $('#' + window.wpActiveEditor)
                .get(0);
            ...
            $(document)
                .trigger('wplink-open', inputs.wrap);
        },
        ...
        close: function() {
            ...
            $(document)
                .trigger('wplink-close', inputs.wrap);
        },
        ...
        updateFields: function(e, li) {
            inputs.url.val(li.children('.item-permalink')
                .val());
        },
    ...
    River = function(element, search) {
        ...
        $('#wp-link .query-results, #wp-link #link-selector')
            .scroll(function() {
                self.maybeLoad();
            });
    ...
    $(document)
        .ready(wpLink.init);
})(jQuery);console.log('wpLink custom');